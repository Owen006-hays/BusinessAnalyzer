  ...
  switch (template) {
    ...
    case "bmc":
      return (
        <div className="template-grid h-full flex flex-col pointer-events-none">
          <div className="flex flex-col h-full">
            <div className="h-full grid grid-cols-1 md:grid-cols-9 md:grid-rows-10 gap-3">
              {/* 上段 (3行): 左側 */}
              <div className="md:col-span-2 md:row-span-3 bg-purple-50 border border-purple-200 rounded p-3 flex flex-col">
                <h3 className="text-purple-700 font-medium text-center border-b border-purple-200 pb-1 mb-2">
                  キーパートナー
                </h3>
              ...
              <div className="md:col-span-2 md:row-span-1 bg-blue-50 border border-blue-200 rounded p-3 flex flex-col">
                <h3 className="text-blue-700 font-medium text-center border-b border-blue-200 pb-1 mb-2">
                  主要活動
                </h3>
              ...
              {/* 中央の価値提案 (3行) */}
              <div className="md:col-span-3 md:row-span-3 bg-teal-50 border border-teal-200 rounded p-3 flex flex-col">
                <h3 className="text-teal-700 font-medium text-center border-b border-teal-200 pb-1 mb-2">
                  価値提案
                </h3>
              ...
              {/* 上段: 右側 */}
              <div className="md:col-span-2 md:row-span-1 bg-indigo-50 border border-indigo-200 rounded p-3 flex flex-col">
                <h3 className="text-indigo-700 font-medium text-center border-b border-indigo-200 pb-1 mb-2">
                  顧客との関係
                </h3>
              ...
              <div className="md:col-span-2 md:row-span-3 bg-green-50 border border-green-200 rounded p-3 flex flex-col">
                <h3 className="text-green-700 font-medium text-center border-b border-green-200 pb-1 mb-2">
                  顧客セグメント
                </h3>
              ...
              {/* 中段 */}
              <div className="md:col-span-2 md:row-span-1 bg-cyan-50 border border-cyan-200 rounded p-3 flex flex-col">
                <h3 className="text-cyan-700 font-medium text-center border-b border-cyan-200 pb-1 mb-2">
                  経営資源
                </h3>
              ...
              <div className="md:col-span-2 md:row-span-1 bg-pink-50 border border-pink-200 rounded p-3 flex flex-col">
                <h3 className="text-pink-700 font-medium text-center border-b border-pink-200 pb-1 mb-2">
                  チャネル
                </h3>
              ...
              {/* 下段: コスト構造と収益の流れ (7行目から10行目まで) */}
              <div className="md:col-span-4 md:row-span-4 bg-amber-50 border border-amber-200 rounded p-3 flex flex-col">
                <h3 className="text-amber-700 font-medium text-center border-b border-amber-200 pb-1 mb-2">
                  コスト構造
                </h3>
