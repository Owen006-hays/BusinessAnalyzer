...
const TemplateSelector: React.FC<TemplateSelectorProps> = ({ template }) => {
  ...
  switch (template) {
      ...
      return (
        <div className="template-grid h-full grid grid-cols-2 grid-rows-2 gap-4">
          <div className="bg-blue-50 border border-blue-200 rounded p-3 flex flex-col">
            ...
            <div className="flex-grow template-dropzone" data-zone="strengths"></div>
          </div>
          <div className="bg-red-50 border border-red-200 rounded p-3 flex flex-col">
            <h3 className="text-red-700 font-medium text-center border-b border-red-200 pb-1 mb-2">
              弱み (Weaknesses)
            </h3>
            <div className="flex-grow template-dropzone" data-zone="weaknesses"></div>
          </div>
          <div className="bg-green-50 border border-green-200 rounded p-3 flex flex-col">
            ...
            <div className="flex-grow template-dropzone" data-zone="opportunities"></div>
          </div>
          <div className="bg-yellow-50 border border-yellow-200 rounded p-3 flex flex-col">
            <h3 className="text-yellow-700 font-medium text-center border-b border-yellow-200 pb-1 mb-2">
              脅威 (Threats)
            </h3>
            <div className="flex-grow template-dropzone" data-zone="threats"></div>
          </div>
        </div>
      );
    ...
    case "4p":
      return (
        <div className="template-grid h-full grid grid-cols-2 grid-rows-2 gap-4">
          <div className="bg-indigo-50 border border-indigo-200 rounded p-3 flex flex-col">
            <h3 className="text-indigo-700 font-medium text-center border-b border-indigo-200 pb-1 mb-2">
              製品 (Product)
            </h3>
            <div className="flex-grow template-dropzone" data-zone="product"></div>
          </div>
          <div className="bg-purple-50 border border-purple-200 rounded p-3 flex flex-col">
            ...
            <div className="flex-grow template-dropzone" data-zone="price"></div>
          </div>
          <div className="bg-pink-50 border border-pink-200 rounded p-3 flex flex-col">
            <h3 className="text-pink-700 font-medium text-center border-b border-pink-200 pb-1 mb-2">
              流通 (Place)
            </h3>
            <div className="flex-grow template-dropzone" data-zone="place"></div>
          </div>
          <div className="bg-teal-50 border border-teal-200 rounded p-3 flex flex-col">
            ...
            <div className="flex-grow template-dropzone" data-zone="promotion"></div>
          </div>
        </div>
      );
    ...
    case "3c":
      return (
        <div className="template-grid h-full grid grid-cols-3 grid-rows-1 gap-4">
          <div className="bg-blue-50 border border-blue-200 rounded p-3 flex flex-col">
            <h3 className="text-blue-700 font-medium text-center border-b border-blue-200 pb-1 mb-2">
              自社 (Company)
            </h3>
            <div className="flex-grow template-dropzone" data-zone="company"></div>
          </div>
          <div className="bg-green-50 border border-green-200 rounded p-3 flex flex-col">
            <h3 className="text-green-700 font-medium text-center border-b border-green-200 pb-1 mb-2">
              顧客 (Customer)
            </h3>
            <div className="flex-grow template-dropzone" data-zone="customer"></div>
          </div>
          <div className="bg-yellow-50 border border-yellow-200 rounded p-3 flex flex-col">
            <h3 className="text-yellow-700 font-medium text-center border-b border-yellow-200 pb-1 mb-2">
              競合 (Competitor)
            </h3>
            <div className="flex-grow template-dropzone" data-zone="competitor"></div>
          </div>
        </div>
      );
      ...
      return (
        <div className="template-grid h-full grid grid-cols-2 grid-rows-2 gap-4">
          ...
          <div className="bg-teal-50 border border-teal-200 rounded p-3 flex flex-col">
            ...
            <div className="flex-grow template-dropzone" data-zone="technological"></div>
          </div>
        </div>
      );
